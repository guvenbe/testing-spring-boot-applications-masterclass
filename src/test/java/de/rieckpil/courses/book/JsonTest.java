...
public class JsonTest {
  ...
  void testWithJsonPath() {
    ...
    Assertions.assertEquals(42, JsonPath.parse(result).read("$.orders[1]", Integer.class));
    Assertions.assertEquals(100, JsonPath.parse(result).read("$.orders.sum()", Integer.class));
  }
}
